      ...
      window.location.href = "/personal_website/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-defended-my-phd-dissertation-teaching-robots-to-learn-from-direct-interaction-and-act-under-uncertainty-and-partial-observability-yes-that-makes-me-dr-doctor",
          title: 'Defended my PhD dissertation. Teaching robots to learn from direct interaction and act...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/personal_website/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
